...
def main():
    ...
    argparser.add_argument("--config", type=str, default="/home/fangly/mllm/ljd/OpenThinkIMG/tool_server/tool_workers/scripts/launch_scripts/config/all_service_smy.yaml", help="Path to configuration file")
